...
CSprite::CSprite ()
{
	...
	m_pWindow = g_pFramework->GetScreen ();
...
void CSprite::Load (const string sFilename)
{
    ...
    Uint32 colorkey = SDL_MapRGB(m_pImage->format, 255, 0, 255);
    SDL_SetColorKey(m_pImage, SDL_TRUE, colorkey);
					...
					int FrameWidth, int FrameHeight)
{
	...
	// Rect f�r Animationsphase initialisieren
